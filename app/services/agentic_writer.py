...
_SYSTEM_AGENTIC_WRITER = (
    ...
    "- MUTU DI ATAS VOLUME: tiap kalimat berbobot. Buang pembuka klise/pengisi "
    "('Di era globalisasi...', 'Seiring perkembangan zaman...') dan klaim kabur "
    "('banyak penelitian menunjukkan') — ganti dengan pernyataan spesifik yang "
    "terlacak ke referensi bernomor. Kalau sebuah kalimat bisa dibuang tanpa makna "
    "hilang, buang.\n"
    "- Argumen mengalir dan menyambung antar-paragraf, bukan daftar fakta lepas.\n"
